...
public class Shop {
    ...
    public Shop(long id, Platform platform, String url, String nick, String address) {
        this.id = id;
    ...
    public static List<Shop> findBySellerId(long id2) {
	 ...
	 */
	public static List<Shop> findByPlatformAndSellerId(Platform platform, long sellerId) {
	 ...
	 */
	public static Page<ShopSearchVo> findAllForAdmin(ShopSearchVo vo) {
	    /*
	     *  过滤下输入条件
	     */
	    // 注册用户昵称
		...
		try {
			...
			Page<ShopSearchVo> page = Page.newInstance(vo.pageNo, vo.pageSize, count);
	...
	public static Shop newInstance(Platform p,String url){
	    Shop s = new Shop();
	    s.url = url;
	    s.platform = p;
	    return s;
	 ...
	 */
	public static Integer updateShop(ShopSearchVo vo) {
		SqlSession ss = SessionFactory.getSqlSession();
		try {
			ShopMapper mapper = ss.getMapper(ShopMapper.class);
	 ...
	 * @created 2015年2月5日 下午4:29:22
	 */
	public static List<Shop> selectByPlatformAndNick(ShopSearchVo vo) {
		SqlSession ss = SessionFactory.getSqlSession();
		try {
			ShopMapper mapper = ss.getMapper(ShopMapper.class);
	 ...
	 */
	public static Shop selectById(long id) {
		SqlSession ss = SessionFactory.getSqlSession();
		try {
			ShopMapper mapper = ss.getMapper(ShopMapper.class);
