...
public class TaskOrderMessage3 {

    public static final String TABLE_NAME = "task_order_message3";
	...
	public static TaskOrderMessage3 newInstance(long taskId){
		TaskOrderMessage3 o = new TaskOrderMessage3();
		o.taskId = taskId;
		return o;
	}
	 ...
	 */
	public static TaskOrderMessage3 getOneMessage(long taskId) {
		SqlSession ss = SessionFactory.getSqlSession();
		try {
			TaskOrderMessageMapper3 tomMapper = ss.getMapper(TaskOrderMessageMapper3.class);
			List<TaskOrderMessage3> toms = tomMapper.selectByTaskId(taskId);
			...
			Ordering<TaskOrderMessage3> ordMessage = new Ordering<TaskOrderMessage3>() {
				public int compare(TaskOrderMessage3 tom1, TaskOrderMessage3 tom2) {
