 ...
 */
public class SellerBalanceVo2 extends Page {
	...
	public static SellerBalanceVo2 newInstence() {
		return new SellerBalanceVo2();
	}

	public SellerBalanceVo2 sellerId(long sellerId) {
		this.sellerId = sellerId;
		return this;
	}
	//计算邮费
	public SellerBalanceVo2 postage() {
	...
	//退款保证金
	public SellerBalanceVo2 refundDeposit() {
	...
	//买手付款
	public SellerBalanceVo2 paidFeeStr() {
	...
	//买手佣金
	public SellerBalanceVo2 baseOrderIngotStr() {
	...
	//平台返款
	public SellerBalanceVo2 sysRefundStr() {
		if(this.sysRefund){
	...
	//总费用
	public SellerBalanceVo2 totalDeposit() {
	 ...
	 */
	public SellerBalanceVo2 buyerTaskcalculate() {
	...
	public SellerBalanceVo2 mobileRefundIngot() {
		BigDecimal decimal=new BigDecimal(this.itemPrice/100).add(new BigDecimal(this.itemPrice*BizConstants.TASK_INSURANCE_RATE/100)).add(new BigDecimal(this.expressIngot/100)).add(new BigDecimal(this.extraRewardIngot));
		if(this.sysRefund){
			decimal=decimal.add(BigDecimal.valueOf(this.itemPrice/100).multiply(BigDecimal.valueOf(BizConstants.TASK_SYS_REFUND)));
		}
	...
	public SellerBalanceVo2 taskSysRefundStr() {
	...
	public SellerBalanceVo2 extraRewardIngot() {
		this.extraRewardIngot=this.extraRewardIngot*this.totalOrderNum;
		return this;
	}
	
	public SellerBalanceVo2 buyTimeInterval() {
	...
	public SellerBalanceVo2 speedExamineStr() {
	...
	public SellerBalanceVo2 publishTimerIntervalStr() {
	 ...
	 */
	public SellerBalanceVo2 taskcalculate() {
