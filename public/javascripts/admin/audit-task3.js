...
function loadTask(pageNo) {
	...
	Tr.get('/admin/sellerTask/exmine/list3', {
...
function updateStatus(id, status) {
	Tr.post('/admin/sellerTask/exmine3', {
		't.id': id,
		't.status': status,
		'memo': CDT.memo,
...
function initBase() {
	...
	$(document).on('click', '#modifyTaskRequestBtn', function() {
		...
		Tr.post('/admin/sellerTask/modifyTaskRequest3', {
