...
//根据平台取某个用户已绑定店铺信息
function loadDianpu(platform2){
	Tr.get('/user/shop2/' + platform2, {}, function(data) {
		var output = '';
...
function addshop2() {
	...
	var platform2 = $('.selectedCtb').attr('value');
	Tr.post('/user/shop/add2', {
		'shop2.platform2': platform2,
		'shop2.address': address,
		'shop2.nick': wangwang,
		'shop2.sellerName': sellerName,
		'shop2.mobile': mobile,
		'shop2.street': street
	}, function(data) {
		if (data.code == 800101) {
